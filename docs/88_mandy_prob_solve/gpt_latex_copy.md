感谢 Rainbow 企鹅写的油猴脚本，Rainbow is the best!
...
(function () {
    ...
    const iconString = '<svg t="1714015504016" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1681" width="18" height="18"><path d="M64 64m64 0l384 0q64 0 64 64l0 0q0 64-64 64l-384 0q-64 0-64-64l0 0q0-64 64-64Z" fill="#7d7d7d" p-id="11122"></path><path d="M64 832m64 0l384 0q64 0 64 64l0 0q0 64-64 64l-384 0q-64 0-64-64l0 0q0-64 64-64Z" fill="#7d7d7d" p-id="11123"></path><path d="M148.854281 42.072792m33.914833 54.275078l237.40383 379.925547q33.914833 54.275078-20.360245 88.189911l0 0q-54.275078 33.914833-88.189911-20.360245l-237.403831-379.925547q-33.914833-54.275078 20.360246-88.189912l0 0q54.275078-33.914833 88.189911 20.360246Z" fill="#7d7d7d" p-id="11124"></path><path d="M39.947907 915.97189m33.943247-54.257313l237.602726-379.801191q33.943247-54.257313 88.20056-20.314066l0 0q54.257313 33.943247 20.314066 88.200559l-237.602726 379.801191q-33.943247 54.257313-88.20056 20.314066l0 0q-54.257313-33.943247-20.314066-88.200559Z" fill="#7d7d7d" p-id="11125"></path><path d="M579.264317 263.095197m45.254834 45.254834l316.783837 316.783838q45.254834 45.254834 0 90.509668l0 0q-45.254834 45.254834-90.509668 0l-316.783837-316.783838q-45.254834-45.254834 0-90.509668l0 0q45.254834-45.254834 90.509668 0Z" fill="#7d7d7d" p-id="11126"></path><path d="M489.022961 670.0189m45.254834-45.254834l316.783838-316.783838q45.254834-45.254834 90.509668 0l0 0q45.254834 45.254834 0 90.509668l-316.783838 316.783838q-45.254834 45.254834-90.509668 0l0 0q-45.254834-45.254834 0-90.509668Z" fill="#7d7d7d" p-id="11127"></path></svg>';
    ...
    function disableKatexRendering(parent) {
        while (parent.getElementsByClassName('katex-mathml').length > 0) {
            ...
            for (let i = 0; i < katexMathmlElements.length; i++) {
                ...
                const sourceCode = annotationElement.textContent.trim();
...
save it to a file with a .user.js extension, for example, `Disable Katex Rendering._js`, and then install it in Tampermonkey or other userscript manager.